...
public class platformSpawner : MonoBehaviour
{
    ...
    private void CreateTheFirstPlatform()
    {
        ...
        if(twoSidedDice >= 0)
        {
            ...
            var position1 = new Vector3(positionX1, 8.51f, rightsidePrefabs[prefabIndex1].transform.position.z);
        ...
        else if(twoSidedDice < 0)
        {
            ...
            var position1 = new Vector3(positionX1, 8.51f, leftsidePrefabs[prefabIndex1].transform.position.z);
